...
from .device_endpoints import led_router, musical_audio_router, voice_router
...
api_router.include_router(musical_audio_router, prefix="/musical-audio", tags=["musical-audio"])
