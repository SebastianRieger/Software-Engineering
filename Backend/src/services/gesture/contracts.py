...
def default_gesture_contracts() -> dict[GestureType, GestureContract]:
    contracts = [
        ...
        GestureContract(
            ...
            gesture="circle",
            display_name="Kreis",
            start_pose="kompakte hand oder faust in der mittleren kamerazone",
            motion_profile="von der mitte einen geschlossenen kreis bis nahe zur ursprungsposition ziehen",
            end_pose="am ausgangspunkt die hand oeffnen, um den kreis zu bestaetigen",
            tempo_hint="gleichmaessige kreisbewegung statt punktweiser richtungswechsel",
            recording_notes=(
                "die hand soll vor dem kreis kompakt vor der mittleren startposition stabilisiert werden",
                "der kreis soll geschlossen zurueck zur ursprungsposition laufen, bevor die hand geoeffnet wird",
            ),
            detector_bias=(
                "compact_hand_preferred",
                "center_anchor_preferred",
                "closed_loop_required",
                "open_commit_required",
            ),
