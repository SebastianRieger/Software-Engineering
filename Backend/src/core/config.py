...
class Settings(BaseSettings):
    ...
    GESTURE_PINCH_POSE_MIN_HAND_OPENNESS: float = 0.38
    GESTURE_PINCH_POSE_MIN_THUMB_EXTENDED: float = 0.4
    GESTURE_PINCH_POSE_MIN_INDEX_EXTENDED: float = 0.55
    GESTURE_PINCH_POSE_MAX_CURLED_SUPPORT_FINGERS: int = 1
    GESTURE_PINCH_POSE_REJECT_FIST_LIKE_THRESHOLD: float = 0.6
    GESTURE_RUNTIME_CIRCLE_START_MAX_OPENNESS: float = 0.42
    GESTURE_RUNTIME_CIRCLE_TRACK_MAX_OPENNESS: float = 0.72
    GESTURE_RUNTIME_CIRCLE_COMMIT_MIN_OPENNESS: float = 0.55
    GESTURE_RUNTIME_CIRCLE_RETURN_MAX_DISTANCE: float = 0.09
    GESTURE_RUNTIME_CIRCLE_CENTER_MAX_DISTANCE: float = 0.28
    GESTURE_RUNTIME_CIRCLE_GAP_MAX_FRAMES: int = 3
    GESTURE_RUNTIME_CIRCLE_OPEN_COMMIT_SECONDS: float = 0.45
    GESTURE_RUNTIME_CIRCLE_PUSH_SUPPRESSION_ENABLED: bool = True
    ...
    GESTURE_SEQUENCE_MATCHING_ENABLED: bool = False
    GESTURE_SEQUENCE_SHADOW_MODE: bool = True
    GESTURE_SEQUENCE_RESAMPLE_POINTS: int = 24
    GESTURE_SEQUENCE_WINDOW: int = 6
    GESTURE_SEQUENCE_MIN_MARGIN: float = 0.08
    GESTURE_SEQUENCE_SCORE_WEIGHT: float = 0.25
