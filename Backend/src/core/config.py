...
class Settings(BaseSettings):
    ...
    GESTURE_CIRCLE_SWEEP_MIN: float = 4.2
    ...
    GESTURE_PUSH_DEPTH_THRESHOLD: float = 0.06
    GESTURE_PUSH_RELEASE_THRESHOLD: float = 0.03
    GESTURE_PUSH_POSE_EXTENSION_RATIO: float = 1.08
    GESTURE_CENTER_TOLERANCE: float = 0.24
