...
def test_segment_push_cycles_detects_two_short_clicks() -> None:
    samples = [
        ...
        PushFrameSample(
            ...
            push_depth=0.08,
            pose_valid=True,
            index_extension_ratio=1.45,
            folded_fingers_count=3,
        ...
        PushFrameSample(
            ...
            push_depth=0.02,
            pose_valid=False,
            index_extension_ratio=0.95,
            folded_fingers_count=1,
        ...
        PushFrameSample(
            ...
            push_depth=0.09,
            pose_valid=True,
            index_extension_ratio=1.48,
            folded_fingers_count=3,
            center_distance=0.07,
        ),
        PushFrameSample(
            timestamp=0.45,
            push_depth=0.14,
            pose_valid=True,
            index_extension_ratio=1.50,
            folded_fingers_count=3,
            center_distance=0.06,
        ),
        PushFrameSample(
            ...
            push_depth=0.01,
            pose_valid=False,
            index_extension_ratio=0.92,
            folded_fingers_count=1,
            center_distance=0.13,
        ),
    ]
...
def test_segment_push_cycles_classifies_long_click_by_hold_duration() -> None:
    ...
    cycles = segment_push_cycles(
        samples, expected_gesture="push_click_long", long_click_seconds=0.5
    )
...
def test_segment_push_cycles_keeps_long_click_through_brief_pose_dropout() -> None:
    samples = [
        ...
        PushFrameSample(
            ...
            push_depth=0.10,
            pose_valid=False,
            index_extension_ratio=1.02,
            folded_fingers_count=2,
            center_distance=0.09,
        ),
        PushFrameSample(
            timestamp=0.50,
            push_depth=0.15,
